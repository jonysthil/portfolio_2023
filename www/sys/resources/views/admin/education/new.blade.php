                        ...
                        <div class="row ">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <select class="form-control @error('edu_month_finish') is-invalid @enderror edu_month_finish" name="edu_month_finish" id="edu_month_finish" {{ (old('edu_current')) ? 'disabled' : '' }}>
                                                @for ($i = 0; $i <= 11; $i++)
                                        ...
                                        <div class="col-md-6">
                                            <select class="form-control @error('edu_year_finish') is-invalid @enderror edu_year_finish" name="edu_year_finish" id="edu_year_finish" {{ (old('edu_current')) ? 'disabled' : '' }}>
                                                @for ($j = date('Y'); $j >= 1800; $j--)
