<form name="modelForm" method="post">
    {{ csrf_field() }}
    {{ method_field('DELETE') }}
<div class="modal fade text-left" id="service-delete" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title text-danger" id="myModalLabel1">Delete Service</h4>
