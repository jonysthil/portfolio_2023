    ...
    <div class="col-md-12 col-sm-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">New Proyect</h4>             
            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="date" value="{{ old('prt_date') }}" name="prt_date" id="prt_date" class="form-control @error('prt_date') is-invalid @enderror">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ old('prt_url') }}" name="prt_url" id="prt_url" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="prt_description" id="prt_description" class="form-control" rows="5">{{ old('prt_description') }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-md-6 text-right">
                                        <a href="{{ route('portfolio') }}" class="btn btn-sm btn-danger">
